...
urlpatterns = [
    ...
    path('auth/profile/tickets/', views_auth.update_tickets_view, name='profile-tickets'),
    path('auth/profile/coins/', views_auth.add_coins_view, name='profile-coins'),
    path('auth/profile/store/buy/', views_auth.buy_tickets_view, name='profile-store-buy'),
    path('auth/profile/upgrade-pro/', views_auth.upgrade_pro_view, name='profile-upgrade-pro'),
    ...
    path('survival/substitute/', views.survival_substitute_view, name='survival-substitute'),
    ...
    path('analytics/calendar/', views_premium.expense_calendar_view, name='expense-calendar'),
    # Monitoring
