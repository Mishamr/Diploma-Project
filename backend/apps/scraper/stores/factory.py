...
import logging
from .base import BaseStoreScraper

logger = logging.getLogger(__name__)

# Реєстр: chain_slug → клас скрепера
_REGISTRY: dict[str, type[BaseStoreScraper]] = {}
...
class ScraperFactory:
    ...
    @staticmethod
    def get_scraper(store_name: str, shop_id: str = "1") -> BaseStoreScraper:
        """
