...
class ProductSerializer(serializers.ModelSerializer):
    ...
    def get_latest_price(self, obj):
        ...
        ).order_by('-recorded_at').values_list('price', flat=True).first()
    ...
    def get_latest_old_price(self, obj):
        ...
        ).order_by('-recorded_at').values_list('old_price', flat=True).first()
        return float(price_obj) if price_obj else None
